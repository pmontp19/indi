...
void MyGLWidget::carregaShaders()
{
  ...
  frangesLoc = glGetUniformLocation (program->programId(), "franges");
  esEscenaLoc = glGetUniformLocation (program->programId(), "esEscena");
