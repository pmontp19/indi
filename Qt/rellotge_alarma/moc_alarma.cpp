...
static const char qt_meta_stringdata_alarma[] = {
    "alarma\0"
};
...
const QMetaObjectExtraData alarma::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject alarma::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_alarma,
      qt_meta_data_alarma, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &alarma::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_alarma))
        return static_cast<void*>(const_cast< alarma*>(this));
